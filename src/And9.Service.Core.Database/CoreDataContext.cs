...
public class CoreDataContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Member>(entity =>
        {
            ...
            entity.HasOne(x => x.SquadPart).WithMany(x => x.Members).HasForeignKey(x => new {x.SquadNumber, x.SquadPartNumber}).IsRequired(false);
        ...
        modelBuilder.Entity<MemberSpecialization>(entity =>
        {
            ...
            entity.HasIndex(x => new {x.MemberId, x.Priority}).IsUnique(true);
        ...
        modelBuilder.Entity<Squad>(entity =>
        {
            ...
            entity.Property(x => x.CreateDate).IsRequired(true).ValueGeneratedOnAdd().HasDefaultValueSql("now()");
        ...
        {
            entity.HasKey(x => new {x.SquadNumber, x.SquadPartNumber});

            entity.HasMany(x => x.Members).WithOne(x => x.SquadPart).HasForeignKey(x => new {x.SquadNumber, x.SquadPartNumber});
        ...
        modelBuilder.Entity<SquadRequest>(entity =>
        {
            ...
            entity.HasIndex(x => x.Accepted).IsUnique(false);
            entity.Property(x => x.IsCanceledByMember).IsRequired(true);
            entity.Property(x => x.CreateDateTime).IsRequired(true).ValueGeneratedOnAdd().HasDefaultValueSql("now()");
